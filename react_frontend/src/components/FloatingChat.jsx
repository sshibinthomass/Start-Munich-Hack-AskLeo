...
export function FloatingChat({
  ...
  return (
    <>
      {showSettings && (
        <div className="floating-chat__settings-overlay" onClick={() => setShowSettings(false)}>
          <div className="floating-chat__settings-modal" ref={settingsRef} onClick={(e) => e.stopPropagation()}>
            <div className="floating-chat__settings-header">
              <span className="floating-chat__settings-title">Settings</span>
              <button
                type="button"
                className="floating-chat__settings-close"
            ...
            <div className="floating-chat__settings-content">
              <div className="floating-chat__settings-mode">
                <label className="floating-chat__settings-radio-label">
                  <input
                    type="radio"
                    name="conversationMode"
                    value="fixed"
                    checked={conversationMode === "fixed"}
                    onChange={(e) => onConversationModeChange(e.target.value)}
                    className="floating-chat__settings-radio"
                  />
                  <span>Fixed Number of Exchanges</span>
                </label>
                <label className="floating-chat__settings-radio-label">
                  <input
                    type="radio"
                    name="conversationMode"
                    value="until_deal"
                    checked={conversationMode === "until_deal"}
                    onChange={(e) => onConversationModeChange(e.target.value)}
                    className="floating-chat__settings-radio"
                  />
              ...
              {conversationMode === "fixed" && (
                <>
                  <label className="floating-chat__settings-label">
                    Number of Exchanges: <strong>{maxExchanges}</strong>
                  </label>
                  <input
                    type="range"
                    min="3"
                    ...
                    onChange={(e) => {
                      ...
                      // Ensure it's always odd
                      const oddValue = value % 2 === 0 ? value + 1 : value;
                      onMaxExchangesChange(oddValue);
                    }}
                    className="floating-chat__settings-slider"
                  />
                  <div className="floating-chat__settings-range">
                    <span>3</span>
                    <span>25</span>
                  </div>
        ...
        {isOpen && (
          ...
          <div className="floating-chat__header">
            <div className="floating-chat__header-left">
              <button
                type="button"
                className="floating-chat__settings-button"
                onClick={() => setShowSettings(!showSettings)}
                title="Settings"
                aria-label="Open settings"
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9C10.3431 9 9 10.3431 9 12C9 13.6569 10.3431 15 12 15Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
